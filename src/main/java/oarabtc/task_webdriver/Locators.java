...
public final class Locators {
    ...
    public static final By FIRST_RESULT_LINK = By.xpath(".//*[@id='sb_ifc0']");
    public static final By IMAGES_BUTTON = By.xpath("//*[@id='hdtb-msb']/div[2]/a");

    public static final By GOOGLE_MAIN_LOGO = By.xpath(".//*[@id='hplogo']");
    public static final By GOOGLE_LOGO = By.xpath(".//*[@id='logocont']");
