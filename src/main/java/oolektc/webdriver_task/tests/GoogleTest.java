...
public class GoogleTest {
    ...
    public void googleImagesTest() {
        ...
        Assert.assertTrue(driver.findElement(Locators.FIRST_RESULT_LINK)
                .getText()
        ...
        imagePage.takeScreenshot("src\\", "screenshot.png");

        homepage = imagePage.navigateToHomePage();
        Assert.assertTrue(driver.findElement(Locators.LOGO).isDisplayed());
        homepage.hideElement(driver.findElement(Locators.LOGO));
        Assert.assertFalse(driver.findElement(Locators.LOGO).isDisplayed());
        ...
        searchResultPage.changeElementColor(driver.findElement(Locators.FIRST_RESULT_LINK), "'rgb(52, 221, 221)'");
        Assert.assertTrue(driver.findElement(Locators.FIRST_RESULT_LINK)
                .getAttribute("style")
