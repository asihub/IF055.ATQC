        ...
        switch (field) {
            case "id":
                listForPrint.stream()
                        .limit(toNumber)
                        .skip(fromNumber - 1)
                        .forEach(number1 -> System.out.println(number1.getId()));
                break;
            case "name":
                listForPrint.stream()
                        .limit(toNumber)
                        .skip(fromNumber - 1)
                        .forEach(number1 -> System.out.println(number1.getName()));
                break;
            case "surname":
                listForPrint.stream()
                        .limit(toNumber)
                        .skip(fromNumber - 1)
                        .forEach(number1 -> System.out.println(number1.getSurname()));
                break;
            case "salary":
                listForPrint.stream()
                        .limit(toNumber)
                        .skip(fromNumber - 1)
                        .forEach(number1 -> System.out.println(number1.monthlySalary()));
                break;
            default:
