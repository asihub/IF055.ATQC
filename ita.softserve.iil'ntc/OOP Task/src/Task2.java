...
public class Task2 {
    public static void main(String[] args) {
        ...
        FixedSalaryWorker.printRangeFromList(listOfFixedSalaryWorkers, "name", 1, 5);

        //The last 3 ids from sorted list of workers who get fixed salary.
        System.out.println("\nThe last three ids of workers who get fixed salary are:");
        FixedSalaryWorker.printRangeFromList(listOfFixedSalaryWorkers, "id", 8, 10);
        ...
        HourSalaryWorker.printRangeFromList(listOfHourSalaryWorkers, "name", 1, 5);

        //The last 3 ids from sorted list of workers who get hourly salary.
        System.out.println("\nThe last three ids of workers who get hourly salary are:");
        HourSalaryWorker.printRangeFromList(listOfHourSalaryWorkers, "id", 8, 10);
